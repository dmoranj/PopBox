...
/**
 * When the service is accessed using organizations, the organization name can be detected from
 * the URL or attached as a header to the request. In this case, this attribute gives the name
 * to containing header.
 *
 * @type {String}
 */
exports.oauthIdToken = "td_resourceowner";
